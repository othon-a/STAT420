...
A quadratic transformation was applied to temperature. The result is less significant than the transformation of pesticides predictor. However, the transformed temperature predictor scattered evenly around the red line as well (see appendix). 
...
plot(lasso_results$lasso_fit, main = "LASSO Regression Coef. Shrink Chart")
```
...
This data indicates year, rain, pesticides and regions are individually significant predictor even at p = 0.001 significance level with regression coefficients of 44.27, 1.7 and 33 for numerical predictors. These
...
Through research, there are better LASSO regression algorithm that is out of this class's coverage to better identify the significance of predictors.
